...
@Repository
public class OrderReactiveRepositoryAdapter extends
        ReactiveAdapterOperations<Order/* change for domain model */, OrderData/* change for adapter model */, String, OrderReactiveRepository>
